...
const float magn_ellipsoid_center[3] = {-16.1939, 103.393, 112.721};
const float magn_ellipsoid_transform[3][3] = {{0.919237, 0.00945379, -0.0322535}, 
                                              {0.00945379, 0.889830, 0.00673593}, 
                                              {-0.0322535, 0.00673593, 0.987039}};
